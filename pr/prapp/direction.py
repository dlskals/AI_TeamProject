...
def direction(start_node, end_node):
    ...
    mymap = folium.Map(location=[coordinates[start_node][0], coordinates[start_node][1]], zoom_start=18)

    folium.Marker(coordinates[start_node], popup='you', icon=folium.Icon(color='red')).add_to(mymap)
